...
def main():
    ...
    if len(lista_csv)==0:
        ...
        if check_data >= len(lista_ut):
            ...
            body = "In allegato il file csv con gli spazzamenti da caricare sul portale del Comune. <br><br> ATTENZIONE: per i mesi di novembre e dicembre ricordarsi di togliere i dati di Portoria che sono già stati caricati!!!!!"
