...
where id_ut = %s'''
    ...
    <br><br><font color="red">Da {0} {1} a {2} {3} ci sono {4} schede ancora da eseguire</font>. 
...
<br><br>Di seguito l'elenco <ul>'''.format(mese_mail, 
                                           anno, 
                                           end_mese_mail,
                                           end_anno_mail,
                                           ut_ne.count(uts[uu]))
    ...
    while snc<len(id_scheda_nc):
        ...
        for unc in lista_ut_nc:
            ...
            #id_schede_ut[id_scheda_nc[snc]] = unc[1]
        snc+=1
...
from topo.zone_amiu za where id_zona = %s'''
    ...
    <font color="red">Da {0} {1} a {2} {3} ci sono  schede ancora da chiudere</font>.
    ...
    <br><br>Nel seguito l'elenco delle UT con schede aperte <ul>'''.format(mese_mail, 
                                                                        anno, 
                                                                        end_mese_mail,
                                                                        end_anno_mail)
    messaggio_end = '</ul>'
