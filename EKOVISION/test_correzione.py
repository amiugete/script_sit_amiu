...
- EKOVISION_CONSUNT_DOPPIE_PERC : 2 schede nello stesso giorno che producono doppia consuntivazione 
        --> in questo caso ai fini della consuntivazione a città metropolitana e ARERA tengo la migliore delle 2  
- EKOVISION_CONSUNT_DOPPIE_TAPPE : questi invece sono frutto degli errori degli itinerari che ci sono nel flusso tra il SIT / UO / Ekovision 
