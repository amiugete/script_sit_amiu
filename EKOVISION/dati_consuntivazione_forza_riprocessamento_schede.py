...
ORDER BY 3"""
    ...
    # correzione percorso 
    select_schede= """SELECT * FROM schede_eseguite_ekovision see 
WHERE see.codice_serv_pred = '0202239201'
and see.data_pianif_iniziale >= '2025'
and see.id_scheda in (792916)
...
"""
    ...
    """check_schede=[
        [478967],[481241],[485006],[487079],[487773],[490528],[491467],[496735],[498010],[498621],[499399],[500987],[502332],[502367],[502658],[503913],[504487],[507199],[508213],[508699],[514608],[514991],[516271],[525453],[526011],[526328],[536618],[538349],[539660],[540261],[541128],[544611],[546066],[546067],[549962],[561642],[563182],[563441],[569353],[573242],[573325],[574351],[579724],[581037],[581465],[584929],[586162],[596498],[596503],[596912],[596918],[602553],[603136],[603254],[604842],[608905],[609039],[609064],[609214],[616106],[616175],[617035],[619502],[620387],[625217],[626278],[626280],[626922],[627674],[627711],[629677],[629678],[630059],[632199],[633416],[636034],[638962],[638986],[639528],[639696],[641039],[641108],[645584],[650689],[652801],[652987],[656928],[661505],[662465],[662527],[662549],[662550],[662843],[662945],[667652],[667780],[668764],[668867],[668918],[668969],[674841],[674944],[674995],[675046],[675532],[676067],[676918],[678325],[678330],[679763],[680910],[685312],[685818],[692009],[693045],[693096],[693147],[693198],[693921],[696853],[697778],[699140],[701619],[703901],[706440],[709943],[711763],[711885],[712201],[712202],[712203],[712460],[712798],[713440],[713507],[715958],[715959],[715972],[715973],[715986],[715987],[716000],[716001],[716239],[716241],[716242],[716243],[716244],[716245],[716246],[716247],[716248],[716249],[716250],[716637],[719920],[725772],[729655],[729873],[730554],[730582],[731619],[731747],[731910],[732055],[734103],[739954],[741135],[741233],[741902],[743179],[743334],[743552],[745243],[745247],[749124],[749222],[753371],[753924],[753975],[754959],[758945],[759573],[761022],[765222],[765243],[767879],[770465],[771039],[772064],[777353],[777373],[778071],[778307],[778308],[778522],[780757]
        ]
    """
    id_schede_problemi=[]
