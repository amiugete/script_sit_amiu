...
def main():
    ...
    data_start=datetime.strptime('20250101', '%Y%m%d').date() # da utilizzare per debug / lanciare manualmente
    #fine_ciclo=oggi
    
    fine_ciclo = datetime.strptime('20251231', '%Y%m%d').date()
    ...
    '''
    try:    
        nome_csv_ekovision="non_previsti_2025.csv"
    ...
    log="/tmp/pysftp.log")
        ...
        with srv.cd('sch_lav_cons/in/2025/'): #chdir to public
